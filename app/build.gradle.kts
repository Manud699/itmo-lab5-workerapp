...
application {
    ...
    mainClass = "workerapp.App"
}

// ==========================================
// ESTA ES LA PARTE QUE NECESITAS AGREGAR:
// ==========================================
tasks.named<JavaExec>("run") {
    // Conecta la entrada estándar (teclado) a la tarea run
    standardInput = System.`in`
    
    // Opcional: Hace que la salida sea más limpia en la terminal
